...
const DocumentationPage = () => {
  ...
  const articles = {
    "Начало работы с залупой": `
      <h2 class="text-2xl font-bold mb-4">Начало работы с залупой</h2>
      <p class="text-gray-700 mb-4">Работа с системой «Залупа» начинается с изучения её основных принципов. Этот инструмент предоставляет мощные возможности для анализа, обработки и оптимизации данных. Здесь мы рассмотрим базовые шаги, которые помогут вам подготовить систему к использованию.</p>
    ...
    "Начало работы с пенисом": `
      <h2 class="text-2xl font-bold mb-4">Начало работы с пенисом</h2>
